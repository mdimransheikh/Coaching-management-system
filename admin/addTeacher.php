...
<div class="grid_10">
    ...
    <?php 
        if($_SERVER['REQUEST_METHOD']=="POST"){
            ...
            $query = "INSERT INTO tbl_teacher(image,name,institute) VALUES('$uploaded_image','$name','$institute')";
            $inserted_rows = $db->insert($query);
            if ($inserted_rows) {
             echo "<span class='success'>Teacher Inserted Successfully.
             </span>";
            }else {
             echo "<span class='error'>Teacher is not inserted !!</span>";
            }
        }
    }
    ?>
